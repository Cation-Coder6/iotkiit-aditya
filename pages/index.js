  ...
  return (
    <div>
            ...
            <div className="container mx-auto">
                <div className="flex items-center">
                    ...
                    <button className="text-secondary lg:hidden">
                        <svg className="current-fill h-6 w-6" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <nav className="hidden lg:flex items-center">
                        <a href="/" className="px-6 py-3 font-bold uppercase text-primary border-b-2 border-primary">Home</a>
                        <a href="#our-process" className="px-6 py-3 font-bold uppercase text-secondary hover:text-primary">Process</a>
                        <a href="#about-us" className="px-6 py-3 font-bold uppercase text-secondary hover:text-primary">About us</a>
                        <a href="#services" className="px-6 py-3 font-bold uppercase text-secondary hover:text-primary">Services</a>
                        <a href="#testimonials" className="px-6 py-3 font-bold uppercase text-secondary hover:text-primary">Testimonials</a>
                        <a href="#contact" className="px-6 py-3 font-bold uppercase bg-primary hover:bg-primary-400 text-secondary rounded">Contact</a>
                    </nav>
                </div>
            </div>
        </header >
      <div className="relative overflow-hidden px-6 pb-6">
        <img src='/images/wave.svg' className="absolute top-0 left-2/5" alt="" />
        <div className="container mx-auto relative">
          <div className="flex flex-col md:flex-row items-center pt-32 pb-16 md:pb-0">
            <div className="md:w-1/2 lg:w-1/3 mb-4 sm:mb-16 md:mb-0">
              <h2 className="text-xl font-bold text-secondary-600 uppercase mb-2">Lorem ipsum dolor</h2>
              <h1 className="text-4xl md:text-5xl font-bold text-secondary leading-tight mb-6 md:mb-10">Social Network Management</h1>
              <a href="/" className="bg-primary px-6 md:px-8 py-3 md:py-4 text-lg md:text-xl text-secondary font-bold uppercase rounded hover:bg-primary-400">More info</a>
            </div>
      ...
      <div id="our-process" className="relative">
        <img src='/images/circle2.svg' className="hidden sm:block absolute top-0 left-0 -mx-32" alt="" />
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 md:pr-8 lg:pr-16">
              <img src='/images/about-us.svg' className="-mt-24 md:mt-0 lg:-mt-24 mb-16 md:mb-0" alt="" />
            </div>
      ...
      <div id="services" className="relative">
        <img src='/images/circle.svg' className="absolute top-0 right-0 mt-64 hidden md:block" alt="" />
        <div className="container mx-auto px-6 py-32 relative">
          ...
          <div className="flex flex-col md:flex-row items-center mb-24 md:mb-16 xl:mb-8 mt-16 md:mt-0 md:mt-16 lg:mt-0">
            <img src='/images/service1.svg' className="md:w-1/3" alt="" />
          ...
          <div className="flex flex-col-reverse md:flex-row items-center mb-24 md:mb-16 xl:mb-8">
            ...
            <img src='/images/service2.svg' className="md:w-1/3" alt="" />
          </div>
          <div className="flex flex-col md:flex-row items-center">
            <img src='/images/service3.svg' className="md:w-1/3" alt="" />
            <div className="md:ml-16 xl:ml-32">
      ...
      <div id="testimonials" className="bg-blue-100">
        <div className="mt-16">
          <div className="bg-blue-500 pt-16 pb-16 md:pb-32 relative">
            <img src='/images/wave3.svg' className="w-full absolute bottom-full h-16 lg:h-auto object-cover object-top" alt="" />
            <div className="container px-6 mx-auto">
                <div className="md:w-2/3 mx-auto relative">
                  <img src='/images/quote.svg' className="absolute top-0 left-0 sm:-ml-16 -mt-4" alt="" />
          ...
          <div className="flex items-center justify-center -mt-8 md:-mt-16 lg:-mt-24 relative">
            <a href="/">
              <Image src='/images/avatar1.jpg' width="128" height="128" className="w-12 h-12 md:w-24 md:h-24 lg:w-32 lg:h-32 mx-2 lg:mx-4 object-cover rounded-full border-2 md:border-4 border-white" alt=""/>
            </a>
            <a href="/">
              <img src='/images/avatar2.jpg' className="w-12 h-12 md:w-24 md:h-24 lg:w-32 lg:h-32 mx-2 lg:mx-4 object-cover rounded-full border-2 md:border-4 border-white" alt="" />
            </a>
            <a href="/">
              <img src='/images/avatar3.jpg' className="w-16 h-16 md:w-32 md:h-32 lg:w-48 lg:h-48 mx-2 lg:mx-4 object-cover rounded-full border-2 md:border-4 border-white" alt="" />
            </a>
            <a href="/">
              <img src='/images/avatar4.jpg' className="w-12 h-12 md:w-24 md:h-24 lg:w-32 lg:h-32 mx-2 lg:mx-4 object-cover rounded-full border-2 md:border-4 border-white" alt="" />
            </a>
            <a href="/">
              <img src='/images/avatar5.jpg' className="w-12 h-12 md:w-24 md:h-24 lg:w-32 lg:h-32 mx-2 lg:mx-4 object-cover rounded-full border-2 md:border-4 border-white" alt="" />
            </a>
          </div>
        </div>
      ...
      <footer className="bg-blue-100">
            <div className="container mx-auto px-6 py-12 text-secondary-500 text-center border-t border-gray-300">
                <p>Made with love by <a href="/" className="text-secondary-900 font-bold underline">IOT Lab KIIT</a></p>
            </div>
        </footer>
    </div>
  )
