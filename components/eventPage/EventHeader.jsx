            ...
            <div className="md:flex md:flex-wrap">
              <div className="md:w-1/2 text-center md:text-left md:pt-16 md:pl-10 lg:pl-0">
                ...
                <div class="xl:w-full lg:w-3/4 mt-4  w-full mx-auto md:text-left  text-center inline-block">
                  ...
                  <p class="leading-relaxed font-mono text-white text-xl" style={{textShadow:"1px 1px #000000"}}>Tell me and I forget, teach me and I may remember, involve me and I learn.</p>
                  <span class="inline-block h-1 w-10 rounded bg-indigo-900 mt-2 mb-2"></span>
