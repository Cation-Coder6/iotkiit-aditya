    ...
    <footer className="text-gray-600 body-font">
      <div className="bg-gray-100 ">
        <div className="container pb-4 sm:pt-4 pt-4 mx-auto flex items-center sm:flex-row flex-col ">
          ...
          <span className="inline-flex  sm:mt-0 mt-4 mb-2 sm:mb-0 justify-center items-center sm:justify-start">
            ...
            <a className="ml-3 text-gray-500">
              <svg
                xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
