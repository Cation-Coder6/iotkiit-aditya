          ...
          <div className="relative lg:flex rounded-lg shadow-2xl overflow-hidden">
            ...
            <div className="relative lg:w-7/12 bg-white">
              ...
              <div className="relative py-12 lg:py-24 px-8 lg:px-16 text-gray-700 leading-relaxed">
                <p>
                  As <strong className="text-gray-900 font-medium">Slack</strong> grows rapidly, using Stripe helps them scale payments easily — supporting everything from getting paid by users around the world to enabling ACH payments for corporate customers.
            </p>
                <p className="mt-6">
                  <a href="#" className="font-medium text-indigo-600 hover:text-indigo-900">Learn more about our users →</a>
                </p>
              </div>
            </div>
          </div>
